class ProdutosController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @produto.update(produto_params)
        format.html { redirect_to @produto, notice: "Produto Autalizado!", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to produtos_path, notice: "Produto Deletado!", status: :see_other }
  ...
  private
    ...
    def produto_params
      params.expect(produto: [ :nome, :tipo, :preco ])
    end
end
